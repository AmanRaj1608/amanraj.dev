...
const projectList = [
  {
    "name": "Offsubmit",
    "description": "Webapp for conducting online examination without internet using Cryptographic algorithms and Hashing techniques. Used Ethereum and IPFS for decentralised storage.",
  ...
  },
  {
    ...
    "description": "Bot to join google meet automatically without opening the browser.",
    "language": "Node.js",
    "stars": "148",
    "forks": "28",
  ...
  {
    "name": "OceanCaller",
    "description": "Built an app using Ocean Protocol to share contact dataset. Integrated Filecoin to persist datasets of users maintaing privacy as well as rewarding users with ocean token",
  ...
  {
    "name": "Ecommerce app",
    "description": "Flipkart clone. Features like category, cart, payments, past orders. Admin can add, delete products. Used Sequelize ORM for MySql database.",
  ...
  {
    "name": "devfest-19",
    "description": "Worked in the core team to co-organize GDG Gandhinagar’s DevFest 19. Developed the webpage in Angular 7 in collaboration with the team.",
    "language": "Angular 7",
    "stars": "9",
    "forks": "11",
